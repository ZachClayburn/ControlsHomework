...
def view_animation(animation: Animation, q_0, q) -> mpl_animation.FuncAnimation:
    return animation.animate(q_0, q)


def save_movie(animation: Animation, q_0, q, saveFileName: str):
    ...
    with movie_writer.saving(fig, saveFileName, 100):
